<%@ Page Title="" Language="C#" MasterPageFile="~/CMS.Master" AutoEventWireup="true"
    CodeBehind="Profile.aspx.cs" Inherits="Mobimp.Edusoft.Web.Test" %>
                        ...
                        <tr>
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td style="width: 347px">
                                            :<asp:Label ID="txtsalutation" runat="server"></asp:Label>
                                        </td>
                            ...
                            <td>
                                <table>
                                    <tr valign="top">
                                        <td>
                                            <div style="float: right; width: 95px; height: 115px; background: #fff url(../EduImages/Employee.jpg) no-repeat top center;">
                    ...
                    <table width="100%">
                        <tr>
                            <td>
                                ...
                                <div class="grid" style="float: left; height:80px; width: 100%">
                                    <asp:GridView ID="GvAssign" CssClass="gridViewHeader" runat="server" EmptyDataText="No record found..."
                                        ...
                                        Width="100%" class="grid" HorizontalAlign="Center">
                                        <Columns>
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    ID</HeaderTemplate>
