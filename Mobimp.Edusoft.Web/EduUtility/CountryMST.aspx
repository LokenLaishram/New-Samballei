<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="CountryMST.aspx.cs" Inherits="Mobimp.Edusoft.Web.EduUtility.CountryMST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
   <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a1" href="../EduUtility/CountryMST.aspx">Country</a></li>
        </ol>
                    ...
                    <div class="row mt10">
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                ...
                                <asp:Label ID="lblcode" runat="server" Text="Country Code "></asp:Label>
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                <asp:Label ID="lbldescription" runat="server" Text="Country Name"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                    ...
                    <div class="row">
                        <div>
                         ...
                         <div id="ClassList" class="col-md-12 customRow ">
                            <asp:GridView ID="GvCountry" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..."  OnPageIndexChanging="GvCountryDetails_PageIndexChanging" 
                               OnSorting="GvCountryDetails_Sorting"     OnRowCommand="GvCountryDetails_RowCommand"
      ...
      <script type="text/javascript">       
       ...
       function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=GvCountry.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
