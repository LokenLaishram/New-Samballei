<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="DesignationMST.aspx.cs" Inherits="Mobimp.Edusoft.Web.EduUtility.DesignationMST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
   <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a1" href="../EduUtility/DesignationMST.aspx">Designation</a></li>
        </ol>
                    ...
                    <div class="row mt10">
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                ...
                                <asp:Label ID="lblcode" runat="server" Text="Designation  Code "></asp:Label>
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                <asp:Label ID="lbldescription" runat="server" Text="Designation  Name"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                    ...
                    <div class="row">
                        <div>
                         ...
                         <div id="ClassList" class="col-md-12 customRow ">
                            <asp:GridView ID="GvDesignation" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..."  
                              OnPageIndexChanging="GvDesignationDetails_PageIndexChanging" OnSorting="GvDesignationDetails_Sorting" 
                              OnRowCommand="GvDesignationDetails_RowCommand"
                                CssClass="footable table-striped" AllowSorting="true"  runat="server" AutoGenerateColumns="false"
                                Style="width: 100%">
                                <Columns>
                                    <asp:BoundField DataField="DesignationID" SortExpression="DesignationID" HeaderText="ID" />
                                   ...
                                   <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblID" Visible="false" runat="server" Text='<%# Eval("DesignationID")%>'></asp:Label>
      ...
      <script type="text/javascript">       
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=GvDesignation.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
