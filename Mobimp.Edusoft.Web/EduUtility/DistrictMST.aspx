<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="DistrictMST.aspx.cs" Inherits="Mobimp.Edusoft.Web.EduUtility.DistrictMST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a1" href="../EduUtility/DistrictMST.aspx">District</a></li>
        </ol>
                    ...
                    <div class="row mt10">
                        <div class="col-md-2 customRow">
                            <div class="form-group">
                                ...
                                <asp:Label ID="lblcode" runat="server" Text="District  Code "></asp:Label>
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                <asp:Label ID="lbldescription" runat="server" Text="District Name"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                ...
                <div class="card_wrapper">
                    ...
                    <div class="row">
                        ...
                        <div id="ClassList" class="col-md-12 customRow ">
                            <asp:GridView ID="GvDistrict" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..."
                                OnPageIndexChanging="GvDistrictDetails_PageIndexChanging" OnSorting="GvDistrictDetails_Sorting"
                                OnRowCommand="GvDistrictDetails_RowCommand"
                                CssClass="footable table-striped" AllowSorting="true" runat="server" AutoGenerateColumns="false"
                                Style="width: 100%">
                                <Columns>
                                    <asp:BoundField DataField="DistrictID" SortExpression="DistrictID" HeaderText="ID" />
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblID" Visible="false" runat="server" Text='<%# Eval("DistrictID")%>'></asp:Label>
    ...
    <script type="text/javascript">       
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=GvDistrict.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
