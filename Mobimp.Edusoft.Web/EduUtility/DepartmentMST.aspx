<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="DepartmentMST.aspx.cs" Inherits="Mobimp.Edusoft.Web.EduUtility.DepartmentMST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
   <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a1" href="../EduUtility/DepartmentMST.aspx">Department</a></li>
        </ol>
                    ...
                    <div class="row mt10">
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                ...
                                <asp:Label ID="lblcode" runat="server" Text="Department Code "></asp:Label>
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                <asp:Label ID="lbldescription" runat="server" Text="Department Name"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                    ...
                    <div class="row">
                        <div>
                         ...
                         <div id="ClassList" class="col-md-12 customRow ">
                            <asp:GridView ID="Gvdepartment" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..."  OnPageIndexChanging="GvDepartmentDetails_PageIndexChanging" OnSorting="GvDepartmentDetails_Sorting" 
                                OnRowCommand="GvDepartmentDetails_RowCommand"
                                CssClass="footable table-striped" AllowSorting="true"  runat="server" AutoGenerateColumns="false"
                                Style="width: 100%">
                                <Columns>
                                    <asp:BoundField DataField="DepartmentID" SortExpression="DepartmentID" HeaderText="ID" />
                                   ...
                                   <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblID" Visible="false" runat="server" Text='<%# Eval("DepartmentID")%>'></asp:Label>
      ...
      <script type="text/javascript">       
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=Gvdepartment.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
