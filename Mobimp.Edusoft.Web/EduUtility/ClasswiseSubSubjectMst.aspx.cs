...
{
    public partial class ClasswiseSubSubjectMst : BasePage
    {
        ...
        private void bindddl()
        {
            ...
            Commonfunction.PopulateDdl(ddlSubSubjectID, mstlookup.GetLookupsList(LookupNames.Subject));
        }
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objsubj.SubSubjectID = Convert.ToInt32(ddlSubSubjectID.SelectedValue == "" ? "0" : ddlSubSubjectID.SelectedValue);
                objsubj.ExamID = Convert.ToInt32(ddlexamtype.SelectedValue == "" ? "0" : ddlexamtype.SelectedValue);
                ...
                int result = objsubjBO.UpdateSubSubjectDetails(objsubj);
        ...
        public List<ClasswiseSubjectData> getSubjectdetails(int curIndex, int pagesize)
        {
            ...
            objsubj.AcademicSessionID = LoginToken.AcademicSessionID;
            objsubj.IsActive = ddlStatus.SelectedIndex == 0 ? true : false;
            return objsubjBO.SearchClasswiseSubSubjectDetails(objsubj);
        }
        ...
        protected void ExportoExcel()
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename= ClasswiseSubjectStudied.xlsx");
