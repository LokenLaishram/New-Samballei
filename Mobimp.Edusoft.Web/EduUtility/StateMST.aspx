<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    CodeBehind="StateMST.aspx.cs" EnableEventValidation="false" Inherits="Mobimp.Edusoft.Web.EduUtility.StateMST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a1" href="../EduUtility/ClassMST.aspx">State Details</a></li>
        </ol>
            ...
            <ContentTemplate>
                    ...
                    <div class="row mt10">
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                ...
                                <asp:Label runat="server" ID="lbl_code" Text="State Code"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                <asp:TextBox ID="txtcode" MaxLength="20" runat="server" class="form-control"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="txt_filter" runat="server"
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                <asp:Label runat="server" ID="lbl_description" Text="State Name"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                ...
                <div class="card_wrapper" id="divsearch" runat="server">
                    ...
                    <div class="row">
                        ...
                        <div id="StateDetails" class="col-md-12 customRow ">
                            <asp:GridView ID="GvStateDetails" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..." OnSorting="GvStateDetails_Sorting1" OnRowCommand="GvStateDetails_RowCommand"
                                CssClass="footable table-striped" AllowSorting="true" runat="server" AutoGenerateColumns="false" OnPageIndexChanging="GvStateDetails_PageIndexChanging"
                                Style="width: 100%">
                                <Columns>
                                    <asp:BoundField DataField="StateID" SortExpression="StateID" HeaderText="ID" />
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblID" Visible="false" runat="server" Text='<%# Eval("StateID")%>'></asp:Label>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('.searchs').on('keyup', function () {
                ...
                $('#StateDetails table tbody tr').each(function () {
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=GvStateDetails.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
