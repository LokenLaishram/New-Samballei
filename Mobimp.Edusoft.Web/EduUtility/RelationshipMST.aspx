<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="RelationshipMST.aspx.cs" Inherits="Mobimp.Edusoft.Web.EduUtility.RelationshipMST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
   <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a1" href="../EduUtility/RelationshipMST.aspx">Relationship Manager</a></li>
        </ol>
                    ...
                    <div class="row mt10">
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                ...
                                <asp:Label ID="lblcode" runat="server" Text="Relationship Code "></asp:Label>
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                <asp:Label ID="lbldescription" runat="server" Text="Relationship Name"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                ...
                <div class="card_wrapper">
                    ...
                    <div class="row">
                        <div>
                         ...
                         <div id="RelationshipList" class="col-md-12 customRow ">
                            <asp:GridView ID="GvRelationship" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..."  
                                 OnPageIndexChanging="GvRelationshipDetails_PageIndexChanging" OnSorting="GvRelationshipDetails_Sorting" 
                                 OnRowCommand="GvRelationshipDetails_RowCommand"
                                CssClass="footable table-striped" AllowSorting="true"  runat="server" AutoGenerateColumns="false"
                                Style="width: 100%">
                                <Columns>
                                    <asp:BoundField DataField="RelationshipID" SortExpression="CastID" HeaderText="ID" />
                                   ...
                                   <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblID" Visible="false" runat="server" Text='<%# Eval("RelationshipID")%>'></asp:Label>
      ...
      <script type="text/javascript">       
          $(document).ready(function () {
              $('.searchs').on('keyup', function () {
                  ...
                  $('#RelationshipList table tbody tr').each(function () {
          ...
          function functionConfirm(event) {
              ...
              swal({
                  ...
                  .then((willDelete) => {
                      if (willDelete) {
                          __doPostBack('<%=GvRelationship.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
