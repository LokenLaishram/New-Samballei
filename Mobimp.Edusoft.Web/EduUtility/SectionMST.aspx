<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    CodeBehind="SectionMST.aspx.cs" EnableEventValidation="false" Inherits="Mobimp.Edusoft.Web.EduUtility.SectionMST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a6" href="../EduUtility/SectionMST.aspx">Add Section </a></li>
            ...
            <ContentTemplate>
                    ...
                    <div class="row mt10">
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlsection" AutoPostBack="true" runat="server" class="form-control " OnSelectedIndexChanged="ddlsection_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                        </div>
                ...
                <div class="card_wrapper" id="divsearch" runat="server">
                    ...
                    <div class="row">
                        ...
                        <div id="SectionList" class="col-md-12 customRow ">
                            <asp:GridView ID="GvSectionDetails" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..." OnSorting="GvSectionDetails_Sorting1" OnRowCommand="GvSectionDetails_RowCommand"
                                CssClass="footable table-striped" AllowSorting="true" runat="server" AutoGenerateColumns="false" OnPageIndexChanging="GvSectionDetails_PageIndexChanging"
                                Style="width: 100%">
                                <Columns>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('.searchs').on('keyup', function () {
                ...
                $('#SectionList table tbody tr').each(function () {
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=GvSectionDetails.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
