<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    CodeBehind="TransportRouteManager.aspx.cs" EnableEventValidation="false" Inherits="Mobimp.Edusoft.Web.EduUtility.TransportRouteManager" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    ...
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li>Transport Route Manager&nbsp;&nbsp;<i class="fa fa-chevron-right" style="font-size: xx-small;" aria-hidden="true"></i></li>
                    ...
                    <div class="row mt10">
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                ...
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                <asp:TextBox ID="txtroute" MaxLength="12" runat="server" class="form-control"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" Enabled="True"
                                    TargetControlID="txtroute" FilterType="LowercaseLetters,UppercaseLetters,Custom" ValidChars=" -">
                                </asp:FilteredTextBoxExtender>
                            </div>
                        </div>
                        <div class="col-md-3 customRow">
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group pull-right" style="margin-top: 1.8em;">
                                ...
                                <asp:Button ID="btnprint" class="btn btn-sm btn-indigo button" runat="server" Text="Print" OnClientClick="return Printroutelist();" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card_wrapper">
                    ...
                    <div class="row">
                        ...
                        <div id="ClassList" class="col-md-12 customRow ">
                            <asp:GridView ID="GvRouteDetails" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..." OnPageIndexChanging="GvRouteDetails_PageIndexChanging"
                                CssClass="footable table-striped" AllowSorting="true" OnSorting="GvRouteDetails_Sorting" OnRowCommand="GvRouteDetails_RowCommand" runat="server" AutoGenerateColumns="false"
                                Style="width: 100%">
                                <Columns>
                                    <asp:BoundField DataField="RouteID" SortExpression="RouteID" HeaderText="ID" />
                                    <asp:BoundField DataField="CODE" SortExpression="CODE" HeaderText="Code" />
                                    <asp:BoundField DataField="Descriptions" SortExpression="Descriptions" HeaderText="Route" />
    ...
    <script type="text/javascript">
        ...
        function Validate() {
            ...
            if (document.getElementById("<%=txtroute.ClientID%>").value == "") {
                str = str + "\n Please enter Description.";
                document.getElementById("<%=txtroute.ClientID %>").focus();
                i++;
            }
            if (str.length > 0) {
                swal({
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=GvRouteDetails.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
        ...
        function Printroutelist() {
            ...
            objRoute = document.getElementById("<%= txtroute.ClientID %>")
            objStatus = document.getElementById("<%= ddlstatus.ClientID %>")
            window.open("../EduUtility/Reports/ReportViewer.aspx?option=RouteList&Description=" + objRoute.value + "&Code=" + objCode.value + "&IsActive=" + objStatus.value )
        }


        $(function () {
            $('[id*=GvRouteDetails]').footable();
        });
