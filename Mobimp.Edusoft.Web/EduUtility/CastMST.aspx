<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="CastMST.aspx.cs" Inherits="Mobimp.Edusoft.Web.EduUtility.CastMST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
   <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a1" href="../EduUtility/CastMST.aspx">Cast</a></li>
        </ol>
                    ...
                    <div class="row mt10">
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                ...
                                <asp:Label ID="lblcode" runat="server" Text="Cast Code "></asp:Label>
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                <asp:Label ID="lbldescription" runat="server" Text="Cast Name"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                    ...
                    <div class="row">
                        <div>
                         ...
                         <div id="ClassList" class="col-md-12 customRow ">
                            <asp:GridView ID="GvCast" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..."  
                                 OnPageIndexChanging="GvCastDetails_PageIndexChanging" OnSorting="GvCastDetails_Sorting" 
                                 OnRowCommand="GvCastDetails_RowCommand"
                                CssClass="footable table-striped" AllowSorting="true"  runat="server" AutoGenerateColumns="false"
                                Style="width: 100%">
                                <Columns>
                                    <asp:BoundField DataField="CastID" SortExpression="CastID" HeaderText="ID" />
                                   ...
                                   <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblID" Visible="false" runat="server" Text='<%# Eval("CastID")%>'></asp:Label>
      ...
      <script type="text/javascript">       
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=GvCast.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
