<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    CodeBehind="MonthlyStudentTypeWiseFeeStructure.aspx.cs" EnableEventValidation="false" Inherits="Mobimp.Edusoft.Web.EduUtility.MonthlyStudentTypeWiseFeeStructure" %>
                            ...
                            <asp:GridView ID="GvFeedetails" AllowPaging="true" EmptyDataText="No record found..." OnRowDataBound="GvFeedetails_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblfeellowed" class="form-control" Visible="false" runat="server" Text='<%# Eval("FeeAllowed")%>'></asp:Label>
                                            <asp:CheckBox ID="chkfeellowed"  runat="server"/>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" Width="1%" />
                                    </asp:TemplateField>
