<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    CodeBehind="EmployeeTypeMST.aspx.cs" Inherits="Mobimp.Edusoft.Web.EduUtility.EmployeeTypeMST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    ...
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a1" href="../EduUtility/EmployeeTypeMST.aspx">Employee Type</a></li>
        </ol>
                    ...
                    <div class="row mt10">
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                ...
                                <asp:Label runat="server" ID="lbl_code" Text="Employee Type Code"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                <asp:TextBox ID="txtcode" MaxLength="20" runat="server" class="form-control"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                    Enabled="True" TargetControlID="txtcode" FilterType="LowercaseLetters,UppercaseLetters,Custom" ValidChars=" -/">
                                </asp:FilteredTextBoxExtender>
                            </div>
                        </div>
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                <asp:Label runat="server" ID="lbl_description" Text="Employee Type"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                <asp:TextBox ID="txtdescription" MaxLength="20" runat="server" class="form-control"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server"
                                    Enabled="True" TargetControlID="txtdescription" FilterType="LowercaseLetters,UppercaseLetters,Custom" ValidChars=" -/">
                                </asp:FilteredTextBoxExtender>
                            </div>
                        </div>
                        <div class="col-md-6 customRow">
                            <div class="form-group pull-right" style="margin-top: 1.8em;">
                                <asp:Button ID="btnsave" runat="server" class="btn btn-sm btn-success button" OnClientClick="return Validate();" Text="Save" OnClick="btnsave_Click" />
                ...
                <div class="card_wrapper" id="divsearch" runat="server">
                    <div class="card_wrapper">
                        <div class="row pad15">
                            ...
                            <div id="EmployeeType List" class="col-md-12 customRow ">
                                <asp:GridView ID="GvEmployeeDetails" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..." OnPageIndexChanging="GvEmployeeDetails_PageIndexChanging"
                                    CssClass="footable table-striped" AllowSorting="true" OnSorting="GvEmployeeDetails_Sorting" OnRowCommand="GvEmployeeDetails_RowCommand" runat="server" AutoGenerateColumns="false"
                                    Style="width: 100%">
                                    <Columns>
                                        <asp:BoundField DataField="EmployeeTypeID" SortExpression="EmployeeTypeID" HeaderText="ID" />
                                        <asp:BoundField DataField="CODE" SortExpression="CODE" HeaderText="Code" />
                                        <asp:BoundField DataField="Descriptions" SortExpression="Descriptions" HeaderText="Employee" />
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblID" Visible="false" runat="server" Text='<%# Eval("EmployeeTypeID")%>'></asp:Label>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('.searchs').on('keyup', function () {
                ...
                $('#EmployeeType List table tbody tr').each(function () {
