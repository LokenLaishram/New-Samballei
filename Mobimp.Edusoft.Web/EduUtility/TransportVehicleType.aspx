<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    CodeBehind="TransportVehicleType.aspx.cs" EnableEventValidation="false" Inherits="Mobimp.Edusoft.Web.EduUtility.TransportVehicleType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    ...
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li>Transport Vehicle Type &nbsp;&nbsp;<i class="fa fa-chevron-right" style="font-size: xx-small;" aria-hidden="true"></i></li>
            ...
            <ContentTemplate>
                <div class="card_wrapper">
                    <div class="row mt10">
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                <asp:Label runat="server" ID="lbl_VehicleType" Text="Vehicle Type"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                <asp:DropDownList ID="ddlvehicletype" OnSelectedIndexChanged="ddlstatus_SelectedIndexChanged" AutoPostBack="true"
                                    runat="server" class="form-control">
                                    <asp:ListItem Value="0">Select Vehicle</asp:ListItem>
                                    <asp:ListItem Value="1">Van</asp:ListItem>
                                    <asp:ListItem Value="2">Bus</asp:ListItem>
                                    <asp:ListItem Value="3">Magic</asp:ListItem>
                                    <asp:ListItem Value="4">winger</asp:ListItem>
                                </asp:DropDownList>                                
                            </div>
                        </div>
                        <div class="col-md-3 customRow">
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group pull-right" style="margin-top: 1.8em;">
                                ...
                                <asp:Button ID="btnprint" class="btn btn-sm btn-indigo button" runat="server" Text="Print" OnClientClick="return Printvehicletypelist();" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card_wrapper">
                    ...
                    <div class="row">
                        ...
                        <div id="ClassList" class="col-md-12 customRow ">
                            <asp:GridView ID="GvVehicleTypeDetails" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..." OnPageIndexChanging="GvVehicleTypeDetails_PageIndexChanging"
                                CssClass="footable table-striped" AllowSorting="true" OnSorting="GvVehicleTypeDetails_Sorting" OnRowCommand="GvVehicleTypeDetails_RowCommand" runat="server" AutoGenerateColumns="false"
                                Style="width: 100%" GridLines="None">
                                <Columns>
                                    <asp:BoundField DataField="ID" SortExpression="ID" HeaderText="ID" />
                                    <asp:BoundField DataField="Code" SortExpression="Code" HeaderText="Code" />
                                    <asp:BoundField DataField="VehicleType" SortExpression="VehicleType" HeaderText="VehicleType" />
    ...
    <script type="text/javascript">
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=GvVehicleTypeDetails.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
        ...
        function Printvehicletypelist() {
            objCode = document.getElementById("<%= txtcode.ClientID %>")
            objVehicleType = document.getElementById("<%= ddlvehicletype.ClientID %>")
            objStatus = document.getElementById("<%= ddlstatus.ClientID %>")
            window.open("../EduUtility/Reports/ReportViewer.aspx?option=VehicleTypeList&VehicleType=" + objVehicleType.value + "&Code=" + objCode.value + "&IsActive=" + objStatus.value )
        }


        $(function () {
            $('[id*=GvVehicleTypeDetails]').footable();
        });
