<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true" CodeBehind="Newstudentadmission.aspx.cs" Inherits="Mobimp.Campusoft.Web.EduFees.Newstudentadmission" %>
            ...
            <div class="product-tab-list tab-pane fade active in" id="tapfeecollection" style="margin-top: -28px;">
                <asp:UpdatePanel ID="upMains" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <div class="card_wrapper">
                            <div class="row">
                                ...
                                <div class="col-md-1 customRow">
                                    <div class="form-group">
                                        <asp:Label ID="lbl_roll" runat="server" Text="ID"></asp:Label>
                                        <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                        <asp:TextBox ID="txt_ID" AutoPostBack="true" OnTextChanged="txt_ID_TextChanged" class="form-control "
                                            runat="server">
                                        </asp:TextBox>
                                ...
                                <div class="col-md-7 customRow">
                                    <div class="form-group">
                                        ...
                                        <asp:Label runat="server" Visible="false" class="form-control"
                                            ID="lbl_studentID"></asp:Label>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-2 customRow">
                                    <div class="form-group">
                                        <asp:Label ID="lbl_optional" runat="server" Text="Optional Subject"></asp:Label>
                                        <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                        <asp:DropDownList ID="ddl_optionalsubject" AutoPostBack="true" OnSelectedIndexChanged="ddl_studenttype_SelectedIndexChanged" class="form-control "
                                            runat="server">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-2 customRow">
                                    <div class="form-group">
                                        <asp:Label ID="lbl_studenttype" runat="server" Text="Student Type"></asp:Label>
                                        <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                        <asp:DropDownList ID="ddl_studenttype" AutoPostBack="true" OnSelectedIndexChanged="ddl_studenttype_SelectedIndexChanged" class="form-control "
                                            runat="server">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                        ...
                        <div class="card_wrapper col-md-8 customRow" style="height: 60vh">
                            <div>
                        ...
                        <div id="bottomFeeCollection" class="card_wrapper col-md-4 customRow" style="height: 60vh" runat="server">
                            <div class="row">
