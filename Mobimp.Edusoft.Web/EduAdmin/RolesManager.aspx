<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    CodeBehind="RolesManager.aspx.cs" EnableEventValidation="false" Inherits="Mobimp.Edusoft.Web.EduAdmin.AddRoles" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    ...
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a1" href="../EduAdmin/RolesManager.aspx">Role Manager</a></li>
        </ol>
                ...
                <div class="card_wrapper">
                    <div class="row mt10">
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                <asp:Label runat="server" ID="lbldescription" Text="Role Name"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                        ...
                        <div class="col-md-2 customRow">
                            <div class="form-group">
                                <asp:Label runat="server" ID="lblactive" Text="Status"></asp:Label>
                        ...
                        <div class="col-md-5 customRow">
                            <div class="form-group pull-right" style="margin-top: 1.8em;">
                                ...
                                <asp:Button ID="btnsearch" class="btn btn-sm btn-info button" UseSubmitBehavior="False" OnClientClick="this.disabled='true';this.value='Please wait..'" runat="server" Text="Search" OnClick="btnsearch_Click" />
                                <asp:Button ID="btncancel" class="btn btn-sm btn-danger button" UseSubmitBehavior="False" OnClientClick="this.disabled='true';this.value='Please wait..'" runat="server" Text="Reset" OnClick="btncancel_Click" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card_wrapper">
                    ...
                    <div class="row">
                        ...
                        <div id="ClassList" class="col-md-12 customRow ">
                            <asp:GridView ID="GvRoledetails" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..." OnPageIndexChanging="GvRoledetails_PageIndexChanging"
                                CssClass="footable table-striped" AllowSorting="true" OnSorting="GvRoleDetails_Sorting" OnRowCommand="GvRoledetails_RowCommand" runat="server" AutoGenerateColumns="false"
                                Style="width: 100%">
                                <Columns>
                                    <asp:BoundField DataField="RoleID" SortExpression="RoleID" HeaderText="ID" />
                                    <asp:BoundField DataField="RoleCode" SortExpression="RoleCode" HeaderText="Code" />
                                    <asp:BoundField DataField="RoleName" SortExpression="RoleName" HeaderText="Name" />
                                    <asp:BoundField DataField="AddedBy" SortExpression="AddedBy" HeaderText="Added By" />
                                    <asp:BoundField DataField="AddedDTM" SortExpression="AddedDTM" HeaderText="Added Date" DataFormatString="{0:dd/MM/yyyy}"/>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            Edit
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblID" Visible="false" runat="server" Text='<%# Eval("RoleID")%>'></asp:Label>
    ...
    <script type="text/javascript">
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=GvRoledetails.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
