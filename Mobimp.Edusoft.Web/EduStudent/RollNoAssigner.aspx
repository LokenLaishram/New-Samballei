<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="RollNoAssigner.aspx.cs" Inherits="Mobimp.Edusoft.Web.EduStudent.RollNoAssigner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    ...
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="activepage" href="../EduStudent/RollNoAssigner.aspx">Roll No Assigner</a></li>
        </ol>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:DropDownList ID="ddlsections" class="form-control" runat="server">
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="lblrollno" class="form-control" Text='<%# Eval("RollNo")%>' MaxLength="3"
                                                 ...
                                                 <asp:TemplateField Visible="false">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txt_admissiondate" class="form-control" Text='<%# Eval("AdmissionDate","{0:dd-MM-yyyy}")%>' 
                                                            runat="server"></asp:TextBox>
                                                    </ItemTemplate>
                                    ...
                                    <div class="row ">
                                        <div class="col-md-12 customRow">
                                            <div class="form-group pull-right" style="margin-top: 1.6em;">
                                                <asp:Button ID="btnUpdate" runat="server" Visible="false" class="btn btn-sm btn-info button " Text="Update" OnClick="btnUpdate_Click" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
