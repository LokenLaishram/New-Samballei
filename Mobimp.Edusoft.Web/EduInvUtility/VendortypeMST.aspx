<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="VendortypeMST.aspx.cs" Inherits="Mobimp.Edusoft.Web.EduInvUtility.VendortypeMST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a1" href="../EduInvUtility/VendortypeMST.aspx">Vendor Type &nbsp;&nbsp;<i class="fa fa-chevron-right" style="font-size: xx-small;" aria-hidden="true"></i></a></li>
            <li><a runat="server" id="a3" href="../EduInvUtility/VendorMST.aspx">Vendor Master</a></li>
        </ol>
            ...
            <contenttemplate>
                    ...
                    <div class="row mt10">
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                <asp:Label runat="server" ID="lbl_description" Text="Vendor Type"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                <asp:TextBox ID="txt_vendortype" MaxLength="100" runat="server" class="form-control custextbox"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                ...
                <div class="card_wrapper">
                    ...
                    <div class="row">
                        ...
                        <div id="vendortypelist" class="col-md-12 customRow ">
                            <asp:GridView ID="Gv_vendortype" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..." OnPageIndexChanging="Gv_vendortype_PageIndexChanging"
                                CssClass="table-bordered table-striped gridviewcss" AllowSorting="true" OnSorting="Gv_vendortype_Sorting" OnRowCommand="Gv_vendortype_RowCommand" runat="server" AutoGenerateColumns="false"
                                Style="width: 100%">
                                <Columns>
                                    <asp:BoundField DataField="VendorTypeID"  SortExpression="VendorTypeID" HeaderText="ID" />
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblID" Visible="false" runat="server" Text='<%# Eval("VendorTypeID")%>'></asp:Label>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('.searchs').on('keyup', function () {
                ...
                $('#vendortypelist table tbody tr').each(function () {
        ...
        function Validate() {
            ...
            if (document.getElementById("<%=txt_vendortype.ClientID%>").value == "") {
                str = str + "\n Please enter group.";
                document.getElementById("<%=txt_vendortype.ClientID %>").focus();
                i++;
            }
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=Gv_vendortype.UniqueID%>', 'Deletes$' + paramID);
                    } else {
