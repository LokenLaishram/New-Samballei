<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="SubgroupMST.aspx.cs" Inherits="Mobimp.Edusoft.Web.EduInvUtility.SubgroupMST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    ...
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a runat="server" id="a1" href="../EduInvUtility/GroupMST.aspx">Group Master &nbsp;&nbsp;<i class="fa fa-chevron-right" style="font-size: xx-small;" aria-hidden="true"></i></a></li>
            <li><a class="active" runat="server" id="a2" href="../EduInvUtility/SubgroupMST.aspx">Subgroup Master&nbsp;&nbsp;<i class="fa fa-chevron-right" style="font-size: xx-small;" aria-hidden="true"></i></a></li>
        </ol>
            ...
            <ContentTemplate>
                    ...
                    <div class="row mt10">
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddl_group" MaxLength="100" runat="server" class="form-control custextbox"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                ...
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                <asp:TextBox ID="txt_Subgroup" MaxLength="100" runat="server" class="form-control custextbox"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group pull-right" style="margin-top: 1.8em;">
                                ...
                                <asp:Button ID="btnprint" Visible="false" class="btn btn-sm btn-success button" OnClick="btnprint_Click" runat="server" Text="Print" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card_wrapper">
                    ...
                    <div class="row">
                        ...
                        <div id="subgrouplist" class="col-md-12 customRow ">
                            <asp:GridView ID="Gv_subgroup" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..." OnPageIndexChanging="Gv_subgroup_PageIndexChanging"
                                CssClass="table-bordered table-striped gridviewcss" AllowSorting="true" OnSorting="Gv_subgroup_Sorting" OnRowCommand="Gv_subgroup_RowCommand" runat="server" AutoGenerateColumns="false"
                                Style="width: 100%">
                                <Columns>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('.searchs').on('keyup', function () {
                ...
                $('#subgrouplist table tbody tr').each(function () {
        ...
        function Validate() {
            ...
            if (document.getElementById("<%=txt_Subgroup.ClientID%>").value == "") {
                str = str + "\n Please enter subgroup.";
                document.getElementById("<%=txt_Subgroup.ClientID %>").focus();
                i++;
            }
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=Gv_subgroup.UniqueID%>', 'Deletes$' + paramID);
                    } else {
