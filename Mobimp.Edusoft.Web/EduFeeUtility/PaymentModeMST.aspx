<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    CodeBehind="PaymentModeMST.aspx.cs" EnableEventValidation="false" Inherits="Mobimp.Edusoft.Web.EduFeeUtility.PaymentModeMST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a1" href="../EduFeeUtility/PaymentModeMST.aspx">Payment Mode Manager</a></li>
        </ol>
                    ...
                    <div class="row mt10">
                        <div class="col-md-4 customRow">
                            <div class="form-group">
                                ...
                                <asp:Label runat="server" ID="lblcode" Text="PaymentMode Code"></asp:Label>
                        ...
                        <div class="col-md-4 customRow">
                            <div class="form-group">
                                <asp:Label runat="server" ID="lbldescription" Text="Payment Mode"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                    ...
                    <div class="row">
                        ...
                        <div id="Paymentdetails" class="col-md-12 customRow ">
                            <asp:GridView ID="GvPaymentdetails" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..." OnPageIndexChanging="GvPaymentdetails_PageIndexChanging"
                                ...
                                Style="width: 100%">
                                <Columns>
                                    <asp:BoundField DataField="PaymentModeID" SortExpression="PaymentModeID" HeaderText="ID" />
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblID" Visible="false" runat="server" Text='<%# Eval("PaymentModeID")%>'></asp:Label>
