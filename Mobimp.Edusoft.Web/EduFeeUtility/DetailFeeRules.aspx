<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true" CodeBehind="DetailFeeRules.aspx.cs" Inherits="Mobimp.Edusoft.Web.EduFeeUtility.DetailFeeRules" %>
                        ...
                        <div class="row">
                            <div class="col-md-3 customRow">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlsessionID" runat="server" class="form-control">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-md-3 customRow">
                            ...
                            <div class="col-md-3 customRow">
                                <div class="form-group pull-right" style="margin-top: 1.6em;">
                                    ...
                                    <asp:Button ID="btn_onetime" runat="server" />
                                    <asp:Button ID="btn_extrarule" runat="server" />
                                    <asp:Button ID="btn_monthlypayment" runat="server" />
                                    <asp:Button ID="bnt_EMI" runat="server" />
                                    <asp:Button ID="btn_Exemption" runat="server" />
                                    <asp:Button ID="btn_InclusiveCategory" runat="server" />
                                    <asp:Button ID="btn_InclusiveOneTime" runat="server" />
                                    <asp:Button ID="btn_InclusiveOtherFeeTypes" runat="server" />
                                    <asp:Button ID="btn_InclusiveMonth" runat="server" />
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:DropDownList ID="ddlpaymenttype" Enabled="false" Width="100px" Class="form-control" runat="server">
                                                </asp:DropDownList>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" Width="1%" />
                                        </asp:TemplateField>
                                    ...
                                    <asp:GridView ID="GvMonthlyPayment" EmptyDataText="No record found..." AutoGenerateColumns="false" CssClass="table-striped table-hover" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtnewfeeamountpop3" runat="server" Height="20px" Width="70px" class="form-control" Text='<%# Eval("FeeAmount_New","{0:0#.##}")%>'></asp:TextBox>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtoldfeeamountpop3" runat="server" Height="20px" Width="70px" class="form-control" Text='<%# Eval("FeeAmount_Old","{0:0#.##}")%>'></asp:TextBox>
                                            ...
                                            <asp:TemplateField Visible="false">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtexemptionpop3" runat="server" Height="20px" Width="70px" class="form-control" Text='<%# Eval("Exemption","{0:0#.##}")%>'></asp:TextBox>
                                    ...
                                    <asp:GridView ID="Gv_InclusiveMonths" EmptyDataText="No record found..." AutoGenerateColumns="false" CssClass="table-striped table-hover" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblInclusiveMonthID" runat="server" Visible="false" Text='<%# Eval("MonthlyID")%>'></asp:Label>
