...
{
    public partial class FeeTypesMaster : BasePage
    {
        ...
        protected void BindDlls()
        {
            ...
            Commonfunction.PopulateDdl(ddl_paymenttype, mstlookup.GetLookupsList(LookupNames.PaymentType));
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                FeesTypeMasterData objfees = new FeesTypeMasterData();
                FeesTypeMasterBO objtypes = new FeesTypeMasterBO();
                ...
                objfees.PaymentTypeID = Convert.ToInt32(ddl_paymenttype.SelectedValue == "" ? "0" : ddl_paymenttype.SelectedValue);
        ...
        public List<FeesTypeMasterData> GetFeeTypesMaster(int curIndex, int pagesize)
        {
            FeesTypeMasterData objfees = new FeesTypeMasterData();
            FeesTypeMasterBO objFeeBO = new FeesTypeMasterBO();
            ...
            return objFeeBO.SearchFeesTypesMaster(objfees);
        }
        private void bindgrid(int index)
        {
            int pagesize = Convert.ToInt32(ddl_show.SelectedValue == "10000" ? lbl_totalrecords.Text : ddl_show.SelectedValue);
            List<FeesTypeMasterData> FeeTypes = GetFeeTypesMaster(index, pagesize);
            if (FeeTypes.Count > 0)
            {
        ...
        protected DataTable GetDatafromDatabase()
        {
            ...
            List<FeesTypeMasterData> FeeTypeDetail = GetFeeTypesMaster(1, size);
            List<FeeTypetoExcel> feetypetoexcel = new List<FeeTypetoExcel>();
            int i = 0;
            foreach (FeesTypeMasterData row in FeeTypeDetail)
            {
        ...
        protected void GvFeeTypes_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                {
                    FeesTypeMasterData objfeetypes = new FeesTypeMasterData();
                    FeesTypeMasterBO objfeetypeBO = new FeesTypeMasterBO();
                    int i = Convert.ToInt16(e.CommandArgument.ToString());
                    GridViewRow gr = GvFeeTypes.Rows[i];
                    Label ID = (Label)gr.Cells[0].FindControl("lblID");
                    objfeetypes.ID = Convert.ToInt32(ID.Text);
                    List<FeesTypeMasterData> GetResult = objfeetypeBO.GetFeesDetailsByID(objfeetypes);
                    if (GetResult.Count > 0)
                    {
                        ...
                        ddl_paymenttype.SelectedValue = Convert.ToString(GetResult[0].PaymentTypeID);
                ...
                {
                    FeesTypeMasterData objfeetype = new FeesTypeMasterData();
                    FeesTypeMasterBO objfeetypeBO = new FeesTypeMasterBO();
                    int i = Convert.ToInt16(e.CommandArgument.ToString());
                    GridViewRow gr = GvFeeTypes.Rows[i];
                    Label ID = (Label)gr.Cells[0].FindControl("lblID");
