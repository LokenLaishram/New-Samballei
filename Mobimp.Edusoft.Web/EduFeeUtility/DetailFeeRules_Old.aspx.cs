...
{
    public partial class DetailFeeRules_Old : BasePage
    {
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result == 1)
                {
                    ...
                    bindgrid(1);
                    System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "AlertBox", "successalert('" + Messagealert_.Alertmessage(result == 1 ? "Add" : "update") + "')", true);
                }
                else if (result == 5)
                {
        ...
        protected void btnaddrowpop1_Click(object sender, EventArgs e)
        {
            foreach (GridViewRow row in GvDetailFee.Rows)
            {
                ...
                {
                    GetOneTimePaymentList(SessionID, ClassID, CategoryID, FeeTypeID, PaymentID, AddRow);
...

        {
            ...
            lblMonthlyPaymentLabel.Text = PaymentID == 2 ? "Monthly" : "EMI";
        ...
        {
            for (int i = 0; i < GvMonthlyPayment.Rows.Count - 1; i++)
            {
                TextBox curTexbox = GvMonthlyPayment.Rows[i].Cells[5].FindControl("txtnewfeeamountpop3") as TextBox;
                TextBox nexTextbox = GvMonthlyPayment.Rows[i + 1].Cells[5].FindControl("txtnewfeeamountpop3") as TextBox;
                curTexbox.Attributes.Add("onkeypress", "return clickEnter('" + nexTextbox.ClientID + "', event)");
                int lastindex = GvMonthlyPayment.Rows.Count - 1;
                if (i + 2 > lastindex)
                {
                    nexTextbox.Attributes.Add("onkeypress", "return clickEnter('" + btnsavepop3.ClientID + "', event)");
                }
            }
            for (int i = 0; i < GvMonthlyPayment.Rows.Count - 1; i++)
            {
                TextBox curTexbox1 = GvMonthlyPayment.Rows[i].Cells[6].FindControl("txtoldfeeamountpop3") as TextBox;
                TextBox nexTextbox1 = GvMonthlyPayment.Rows[i + 1].Cells[6].FindControl("txtoldfeeamountpop3") as TextBox;
                curTexbox1.Attributes.Add("onkeypress", "return clickEnter('" + nexTextbox1.ClientID + "', event)");
                int lastindex = GvMonthlyPayment.Rows.Count - 1;
                if (i + 2 > lastindex)
                {
                    nexTextbox1.Attributes.Add("onkeypress", "return clickEnter('" + btnsavepop3.ClientID + "', event)");
                }
            }
            for (int i = 0; i < GvMonthlyPayment.Rows.Count - 1; i++)
            {
                TextBox curTexbox2 = GvMonthlyPayment.Rows[i].Cells[6].FindControl("txtexemptionpop3") as TextBox;
                TextBox nexTextbox2 = GvMonthlyPayment.Rows[i + 1].Cells[6].FindControl("txtexemptionpop3") as TextBox;
                curTexbox2.Attributes.Add("onkeypress", "return clickEnter('" + nexTextbox2.ClientID + "', event)");
                int lastindex = GvMonthlyPayment.Rows.Count - 1;
                if (i + 2 > lastindex)
                {
                    nexTextbox2.Attributes.Add("onkeypress", "return clickEnter('" + btnsavepop3.ClientID + "', event)");
                }
            }
            for (int i = 0; i < GvMonthlyPayment.Rows.Count - 1; i++)
            {
                TextBox curTexbox2 = GvMonthlyPayment.Rows[i].Cells[6].FindControl("txt_emi") as TextBox;
                TextBox nexTextbox2 = GvMonthlyPayment.Rows[i + 1].Cells[6].FindControl("txt_emi") as TextBox;
                curTexbox2.Attributes.Add("onkeypress", "return clickEnter('" + nexTextbox2.ClientID + "', event)");
                int lastindex = GvMonthlyPayment.Rows.Count - 1;
                if (i + 2 > lastindex)
                {
            ...
            for (int i = 0; i < GvMonthlyPayment.Rows.Count - 1; i++)
            {
                TextBox curTexbox2 = GvMonthlyPayment.Rows[i].Cells[6].FindControl("txt_computerfee") as TextBox;
                TextBox nexTextbox2 = GvMonthlyPayment.Rows[i + 1].Cells[6].FindControl("txt_computerfee") as TextBox;
                curTexbox2.Attributes.Add("onkeypress", "return clickEnter('" + nexTextbox2.ClientID + "', event)");
                int lastindex = GvMonthlyPayment.Rows.Count - 1;
                if (i + 2 > lastindex)
                {
        ...
        protected void btnsavepop3_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in GvMonthlyPayment.Rows)
            {
                ...
                TextBox txt_emi = (TextBox)GvMonthlyPayment.Rows[row.RowIndex].Cells[0].FindControl("txt_emi");
                ...
                TextBox txt_computerfee = (TextBox)GvMonthlyPayment.Rows[row.RowIndex].Cells[0].FindControl("txt_computerfee");
                ...
                objXmlmonthly.EMI = Convert.ToInt32(txt_emi.Text == "" ? "0" : txt_emi.Text.Trim());
                objXmlmonthly.Exemption = Convert.ToDecimal(Exemption.Text == "" ? "0" : Exemption.Text.Trim());
                objXmlmonthly.Computerfee = Convert.ToDecimal(txt_computerfee.Text == "" ? "0" : txt_computerfee.Text.Trim());
                if (IsActivate.Checked == true)
                {
