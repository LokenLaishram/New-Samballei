<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true" CodeBehind="FeeTypesMaster.aspx.cs" Inherits="Mobimp.Edusoft.Web.EduFeeUtility.FeeTypesMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a runat="server" class="active" id="activepage" href="../EduFeeUtility/FeeTypesMaster.aspx">Fee Type Master</a></li>
        </ol>
                ...
                <ContentTemplate>
                    <div class="card_wrapper">
                        <div class="row pad15">
                            ...
                            <div class="col-md-2 customRow">
                                <div class="form-group">
                                    <asp:Label ID="lblcategory" runat="server" Text="Fee Category"></asp:Label>
                                    <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                            ...
                            <div class="col-md-2 customRow">
                                <div class="form-group">
                                    ...
                                    <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                    <asp:DropDownList ID="ddl_paymenttype" runat="server" class="form-control">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-md-2 customRow">
                            ...
                            <div id="FeeTypeList" class="col-md-12 customRow ">
                                <asp:GridView ID="GvFeeTypes" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..."
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="FeeCode" SortExpression="FeeCode" HeaderText="Code" />
                                        <asp:BoundField DataField="FeeName" SortExpression="FeeName" HeaderText="Fee Type" />
                                        <asp:BoundField DataField="CategoryName" SortExpression="CategoryName" HeaderText="Fee Category" />
    ...
    <script type="text/javascript">
        ...
        function Validate() {
            ...
            if (document.getElementById("<%=txtfeecode.ClientID%>").value == "") {
                str = str + " Please enter Code.\n"
                document.getElementById("<%=txtfeecode.ClientID %>").focus()
                i++
            }
            if (document.getElementById("<%=txtfeetype.ClientID%>").value == "") {
                str = str + " Please select Fee Type.\n"
                document.getElementById("<%=txtfeetype.ClientID %>").focus()
                i++
            }
            ...
            if (document.getElementById("<%=ddl_paymenttype.ClientID%>").selectedIndex == "0") {
                str = str + " Please select Payment Type.\n"
