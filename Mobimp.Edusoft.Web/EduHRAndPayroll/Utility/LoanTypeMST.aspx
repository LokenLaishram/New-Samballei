<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true" CodeBehind="LoanTypeMST.aspx.cs" Inherits="Mobimp.Campusoft.Web.EduHRAndPayroll.Utility.LoanTypeMST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a1" href="../EduHRAndPayroll/Utility/LoanTypeMST.aspx">Loan Type</a></li>
        </ol>
            ...
            <ContentTemplate>
                <div class="card_wrapper">
                    <div class="row mt10">
                        ...
                        <div class="col-md-2 customRow">
                            <div class="form-group">
                                <asp:Label runat="server" ID="lbl_description" Text="Loan Type"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                        ...
                        <div class="col-md-2 customRow">
                            <div class="form-group">
                                <asp:Label runat="server" ID="lblloantenure" Text="Loan Tenure( In Months)"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                <asp:TextBox ID="txt_loantenure" runat="server" class="form-control"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" Enabled="True"
                                    TargetControlID="txt_loantenure" FilterType="Numbers" ValidChars=" -">
                                </asp:FilteredTextBoxExtender>
                            </div>
                        </div>
                        <div class="col-md-2 customRow">
                            <div class="form-group">
                                <asp:Label runat="server" ID="Label1" Text="Interest Rate PA"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                <asp:TextBox ID="txt_interestrate" runat="server" class="form-control"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" Enabled="True"
                                    TargetControlID="txt_interestrate" ValidChars="1234567890.">
                                </asp:FilteredTextBoxExtender>
                            </div>
                        </div>
                        <div class="col-md-2 customRow">
                ...
                <div class="card_wrapper" id="divsearch" runat="server">
                    ...
                    <div class="row">
                        ...
                        <div id="LoanList" class="col-md-12 customRow ">
                            <asp:GridView ID="GvLoanTypeDetails" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..." OnPageIndexChanging="GvLoanTypeDetails_PageIndexChanging"
                                CssClass="footable table-striped" AllowSorting="true" OnSorting="GvLoanTypeDetails_Sorting" OnRowCommand="GvLoanTypeDetails_RowCommand" runat="server" AutoGenerateColumns="false"
                                Style="width: 100%">
                                <Columns>
                                    <asp:BoundField DataField="LoanID" SortExpression="LoanID" HeaderText="Sl. No" ItemStyle-Width="1%" />
                                    <asp:BoundField DataField="Code" SortExpression="Code" HeaderText="Code" />
                                    <asp:BoundField DataField="Descriptions" SortExpression="Descriptions" HeaderText="Loan Type" />
                                    <asp:BoundField DataField="LoanTenure" SortExpression="LoanTenure" HeaderText="Tenure in Months" />
                                    <asp:BoundField DataField="InterestRate" SortExpression="InterestRate" HeaderText="Rate in PA %" />
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblID" Visible="false" runat="server" Text='<%# Eval("LoanID")%>'></asp:Label>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('.searchs').on('keyup', function () {
                ...
                $('#LoanList table tbody tr').each(function () {
        ...
        function Validate() {
            ...
            if (document.getElementById("<%=txt_loantenure.ClientID%>").value == "") {
                str = str + "\n Please enter Loan tenure.";
                document.getElementById("<%=txt_loantenure.ClientID %>").focus();
                i++;
            }
            if (document.getElementById("<%=txt_interestrate.ClientID%>").value == "") {
                str = str + "\n Please enter Interest rate.";
                document.getElementById("<%=txt_interestrate.ClientID %>").focus();
                i++;
            }
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=GvLoanTypeDetails.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
