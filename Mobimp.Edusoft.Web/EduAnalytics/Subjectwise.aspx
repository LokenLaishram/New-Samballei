<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    CodeBehind="Subjectwise.aspx.cs" Inherits="Mobimp.Campusoft.Web.EduStudent.Subjectwise" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    ...
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" id="activepage" runat="server" href="../EduAnalytics/Subjectwise.aspx">Subject wise&nbsp;&nbsp;<i class="fa fa-chevron-right" style="font-size: xx-small;" aria-hidden="true"></i></a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-3 customRow">
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="ddlexam" runat="server" class="form-control " AutoPostBack="true" OnSelectedIndexChanged="ddlexam_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                </div>
            </div>
