<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    CodeBehind="StudentSubjectwise.aspx.cs" Inherits="Mobimp.Campusoft.Web.EduStudent.StudentSubjectwise" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    ...
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" id="activepage" runat="server" href="../EduAnalytics/StudentSubjectwise.aspx">Student Subjectwise&nbsp;&nbsp;<i class="fa fa-chevron-right" style="font-size: xx-small;" aria-hidden="true"></i></a></li>
        </ol>
