<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    CodeBehind="RackGroup.aspx.cs" EnableEventValidation="false" Inherits="Mobimp.Edusoft.Web.EduLibrary.RackGroup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    ...
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a5" href="../EduLibrary/RackGroup.aspx">Add Rack Group </a>&nbsp;<i class="fa fa-chevron-right" style="font-size: xx-small;" aria-hidden="true"></i></li>
            <li><a runat="server" id="a6" href="../EduLibrary/RackSubGroup.aspx">Add Rack Sub-Group </a>&nbsp;<i class="fa fa-chevron-right" style="font-size: xx-small;" aria-hidden="true"></i></li>
        </ol>
                    ...
                    <div class="row mt10">
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                ...
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                <asp:TextBox ID="txtgroup" MaxLength="20" runat="server" class="form-control"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" Enabled="True"
                                    TargetControlID="txtgroup" FilterType="LowercaseLetters,UppercaseLetters,Custom" ValidChars=" -">
                                </asp:FilteredTextBoxExtender>
                            </div>
                        </div>
                        <div class="col-md-3 customRow">
                ...
                <div class="card_wrapper">
                    ...
                    <div class="row">
                        ...
                        <div id="Racklist" class="col-md-12 customRow ">
                            <asp:GridView ID="GvRackGroupDetails" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..." OnPageIndexChanging="GvRackGroupDetails_PageIndexChanging"
                                CssClass="footable table-striped" AllowSorting="true" OnSorting="GvRackGroupDetails_Sorting" OnRowCommand="GvRackGroupDetails_RowCommand" runat="server" AutoGenerateColumns="false"
                                Style="width: 100%">
                                <Columns>
    ...
    <script type="text/javascript">
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=GvRackGroupDetails.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
        ...
        $(function () {
            $('[id*=GvRackGroupDetails]').footable();
        });
