<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    CodeBehind="BookReturn.aspx.cs" EnableEventValidation="false" Inherits="Mobimp.Edusoft.Web.EduLibrary.BookReturn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    ...
    <div class="container-fluid" id="page_wrapper">
        ...
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a6" href="../EduLibrary/BookReturn.aspx">Book Issue </a>&nbsp;<i class="fa fa-chevron-right" style="font-size: xx-small;" aria-hidden="true"></i></li>
        </ol>
        <div class="review-tab-pro-inner">
            <ul id="myTab3" class="tab-review-design">
                <li class="active"><a href="#tabbookreturn"><i class="icon nalika-edit" aria-hidden="true"></i>Book Return</a></li>
                <li><a href="#tabbookreturnlist"><i class="icon nalika-picture" aria-hidden="true"></i>Book Return List</a></li>
            </ul>
            <div id="myTabContent" class="tab-content custom-product-edit">
                <div class="product-tab-list tab-pane fade active in" id="tabbookreturn">
                        ...
                        <ContentTemplate>
                            <div class="card_wrapper">
                                <div class="row mt10">
                                    ...
                                    <div class="col-md-2 customRow">
                                        ...
                                        <asp:TextBox ID="txtissueno" runat="server" class="form-control" OnTextChanged="txtissueno_TextChanged" AutoPostBack="true"></asp:TextBox>
                                    </div>
                                ...
                                <div class="row mt10">
                                    <div class="col-md-3 customRow">
                                        <div class="form-group ">
                                            ...
                                            <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                                            <asp:TextBox ID="txtreturndate" type="text" runat="server" class="form-control"  AutoPostBack="true"></asp:TextBox>
                            ...
                            <div class="card_wrapper">
                                <div style="height: 160px; width: 100%; overflow: auto; padding: 5px 0px 10px 0px;">
                                    ...
                                    <div id="Racklist" class="col-md-12 customRow ">
                                        <asp:GridView ID="GvBookReturnDetails" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..."
                                            CssClass="footable table-striped" runat="server" AutoGenerateColumns="false" OnRowDataBound="GvBookReturnDetails_RowDataBound"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Group">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblissueid" Visible="false" runat="server" Text='<%# Eval("IssueID")%>'></asp:Label>
                                                ...
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkisreturn" AutoPostBack="true" runat="server" OnCheckedChanged="checkboxes_SelectedIndexChanged" />
                                                    <asp:Label ID="lblisreturn" Visible="false" runat="server" Text='<%# Eval("IsReturn")%>'></asp:Label>
                                                    <asp:Label ID="lblreturnstatus" Visible="false" runat="server" Text='Returned'></asp:Label>
                                                </ItemTemplate>
                            ...
                            <div class="col-md-12 customRow" style="text-align: right">
                                <div class="RtextAlign" style="padding: 0px 0px 0px 0px;">
                                    ...
                                    <asp:Button ID="btnprint" Class="btn btn-sm btn-indigo button" runat="server" Text="Print" OnClientClick="return PrintBookReturnReceipt()" />
                                </div>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                ...
                <div class="product-tab-list tab-pane" id="tabbookreturnlist">
                        ...
                        <ContentTemplate>
                            ...
                            <div class="card_wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div id="Bookreturnlist2" class="col-md-12 customRow ">
                                        <asp:GridView ID="GvBookreturnlist" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..." OnPageIndexChanging="GvBookreturnlist_PageIndexChanging"
                                            CssClass="footable table-striped" AllowSorting="true" OnSorting="GvBookreturnlist_Sorting" OnRowCommand="GvBookreturnlist_RowCommand" runat="server" AutoGenerateColumns="false"
                                            Style="width: 100%" OnRowDataBound="GvBookreturnlist_OnRowDataBound" GridLines="None">
                                            <Columns>
                                                        ...
                                                        <div id="div<%# Eval("IssueNo") %>" style="display: none;">
                                                            <asp:GridView ID="GridChild" runat="server" AutoGenerateColumns="false" DataKeyNames="IssueNo"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField ItemStyle-Width="72px" DataField="ReturnStatus" HeaderText="ReturnStatus" />
                                                                </Columns>
                                                            </asp:GridView>
                                                        </div>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <a href="javascript: void(null);" style="color: red" onclick="Printbills('<%# Eval("IssueNo")%>'); return false;">
    ...
    <script type="text/javascript">
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=GvBookReturnDetails.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
        ...
        $(function () {
            $('[id*=GvBookReturnDetails]').footable();
        });
        ...
        function PrintBookReturnReceipt() {
            ...
            window.open("../EduLibrary/Reports/ReportViewer.aspx?option=BookReturnReceipt&IssueNo=" + objissueno.value + "&typeID=" + objTypeID.value + "&AcademicSessionID=" + objacademicID.value)
        }
    </script>
</asp:Content>
