...
{
    public partial class SubjectGradeMaster : BasePage
    {
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ExamGradeBO objexamBO = new ExamGradeBO();
                objData.SubjectGrade = txtGrade.Text;
                ...
                int result = objexamBO.UpdateSubjectGrade(objData);
        ...
        protected void GvSubjectGrade_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "Edits")
                {
                    ...
                    GridViewRow gr = GvSubjectGrade.Rows[i];
                    Label ID = (Label)gr.Cells[0].FindControl("lblID");
                    objexam.GradeID = Convert.ToInt32(ID.Text);
                

                    List<ExamGradeData> GetResult = objexamBO.GetSubjectGradeByID(objexam);
                    if (GetResult.Count > 0)
                    {
                        txtGrade.Text = GetResult[0].SubjectGrade;
                ...
                if (e.CommandName == "Deletes")
                {
                    ...
                    int Result = objexamBO.DeleteSubjectGradeByID(objgrade);
                    if (Result == 1)
                    {
        ...
        private void bindgrid(int index)
        {
            ...
            if (lstclass.Count > 0)
            {
                GvSubjectGrade.PageSize = pagesize;
                ...
                GvSubjectGrade.VirtualItemCount = lstclass.Count;//total item is required for custom paging
                GvSubjectGrade.PageIndex = index - 1;
                GvSubjectGrade.DataSource = lstclass;
                GvSubjectGrade.DataBind();
                ds = ConvertToDataSet(lstclass);
                TableCell tableCell = GvSubjectGrade.HeaderRow.Cells[0];
                Image img = new Image();
            ...
            {
                GvSubjectGrade.DataSource = null;
                GvSubjectGrade.DataBind();
            }
        }
        ...
        {
            //Responsive 
            GvSubjectGrade.HeaderRow.Cells[0].Attributes["data-class"] = "expand";
            // GvstudentDetails.HeaderRow.Cells[1].Attributes["data-hide"] = "phone,tablet";
            GvSubjectGrade.HeaderRow.Cells[2].Attributes["data-hide"] = "phone,tablet";
            GvSubjectGrade.HeaderRow.Cells[3].Attributes["data-hide"] = "phone,tablet";
            GvSubjectGrade.HeaderRow.Cells[4].Attributes["data-hide"] = "phone,tablet";
            // GvSubjectGrade.HeaderRow.Cells[5].Attributes["data-hide"] = "phone,tablet";
            //GvSubjectGrade.HeaderRow.Cells[6].Attributes["data-hide"] = "phone,tablet";
            //  Adds THEAD and TBODY to GridView.
            GvSubjectGrade.UseAccessibleHeader = true;
            GvSubjectGrade.HeaderRow.TableSection = TableRowSection.TableHeader;
        }
        ...
        protected void GvSubjectGrade_Sorting(object sender, GridViewSortEventArgs e)
        {
            try
            {
                ...
                dt = ds.Tables[0];
                {
                    ...
                    GvSubjectGrade.DataSource = sortedView;
                    GvSubjectGrade.DataBind();
                    bindresponsive();
                    TableCell tableCell = GvSubjectGrade.HeaderRow.Cells[ColumnIndex];
                    Image img = new Image();
