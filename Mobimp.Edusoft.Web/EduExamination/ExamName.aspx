<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" AutoEventWireup="true"
    CodeBehind="ExamName.aspx.cs" EnableEventValidation="false" Inherits="Mobimp.Campusoft.Web.EduExamination.ExamName" %>
                    ...
                    <div class="row mt10">
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                ...
                                <asp:Label runat="server" ID="lblcodes" Text="Exam Code"></asp:Label>
                        ...
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                <asp:Label runat="server" ID="lbldescription" Text="Exam Name"></asp:Label>
                                <span class="mandatory_field">*</span><span style="color: #ff0000"></span>
                ...
                <div class="card_wrapper">
                    ...
                    <div class="row">
                        ...
                        <div id="ClassList" class="col-md-12 customRow ">
                            <asp:GridView ID="GvExamDetails" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..." AutoGenerateColumns="false"
                                CssClass="footable table-striped" AllowSorting="true" OnSorting="GvExamDetails_Sorting" OnRowCommand="GvExamDetails_RowCommand" runat="server"
                                Style="width: 100%">
                                <Columns>
                                    <asp:TemplateField HeaderText="ID">
                                        <ItemTemplate>
                                            <asp:Label ID="lblID" runat="server" Text='<%# Eval("ExamID")%>'></asp:Label>
                                        </ItemTemplate>
