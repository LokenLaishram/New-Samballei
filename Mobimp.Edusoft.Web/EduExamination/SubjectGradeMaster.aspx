<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="SubjectGradeMaster.aspx.cs" Inherits="Mobimp.Campusoft.Web.EduExamination.SubjectGradeMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    ...
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a1" href="../EduExamination/SubjectGradeMaster.aspx">Subject Grade Master</a></li>
        </ol>
                    ...
                    <div class="row mt10">
                        <div class="col-md-3 customRow">
                            <div class="form-group">
                                ...
                                <asp:Label runat="server" ID="lblgrade" Text="Subject Grade( Use UpperCase )"></asp:Label>
                ...
                <div class="card_wrapper">
                    ...
                    <div class="row">
                        ...
                        <div id="ClassList" class="col-md-12 customRow ">
                            <asp:GridView ID="GvSubjectGrade" AllowPaging="true" AllowCustomPaging="true" EmptyDataText="No record found..." AutoGenerateColumns="false"
                                CssClass="footable table-striped" AllowSorting="true" OnSorting="GvSubjectGrade_Sorting" OnRowCommand="GvSubjectGrade_RowCommand" runat="server"
                                Style="width: 100%">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Grade">
                                        <ItemTemplate>
                                            <asp:Label ID="lblgrade" runat="server" Text='<%# Eval("SubjectGrade") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" Width="1%" />
                                    </asp:TemplateField>
    ...
    <script type="text/javascript">
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=GvSubjectGrade.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
