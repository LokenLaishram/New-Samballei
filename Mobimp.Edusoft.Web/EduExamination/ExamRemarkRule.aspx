<%@ Page Title="" Language="C#" MasterPageFile="~/Campusoft.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ExamRemarkRule.aspx.cs" Inherits="Mobimp.Campusoft.Web.EduExamination.ExamRemarkRule" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CampusoftPlaceholder" runat="server">
    ...
    <div class="container-fluid" id="page_wrapper">
        <ol class="breadcrumb">
            ...
            <li><a class="active" runat="server" id="a1" href="../EduExamination/ExamRemarkRuleMaster.aspx">Exam Remark Rule Master</a></li>
        </ol>
                ...
                <div class="card_wrapper">
                    ...
                    <div class="row">
                        ...
                        <div id="ClassList" class="col-md-12 customRow ">
                            <asp:GridView ID="GvExamRemarkRule" AllowPaging="false" AllowCustomPaging="true" EmptyDataText="No record found..." AutoGenerateColumns="false"
                                CssClass="footable table-striped" AllowSorting="true" runat="server"
                                Style="width: 100%">
                                <%-- OnSorting="GvExamRemarkRule_Sorting" OnRowCommand="GvExamRemarkRule_RowCommand"--%>
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Mark From">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtMarkFrom" Height="20px" class="form-control custextbox" runat="server" Text='<%# Eval("MarkFrom")%>'></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txtMarkFrom" ID="FilteredTextBoxExtender1" runat="server" ValidChars="1234567890">
                                    ...
                                    <asp:TemplateField HeaderText="Mark UpTo">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtMarkUpTo" Height="20px" class="form-control custextbox" runat="server" Text='<%# Eval("MarkUpTo")%>'></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txtMarkUpTo" ID="FilteredTextBoxExtender2" runat="server" ValidChars="1234567890">
                                            </asp:FilteredTextBoxExtender>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" Width="1%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Mark Remarks">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtMarkRemark" Height="20px" class="form-control custextbox" runat="server" Text='<%# Eval("MarkRemarks")%>'></asp:TextBox>
                                            <asp:FilteredTextBoxExtender TargetControlID="txtMarkRemark" ID="FilteredTextBoxExtender3" runat="server" ValidChars="abcdefghijklmnopqrstuvwxyz.1234567890 ABCDEFGHIJKLMNOPQRSTUVWXYZ">
                                            </asp:FilteredTextBoxExtender>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" Width="4%" />
                                    </asp:TemplateField>
    ...
    <script type="text/javascript">
        ...
        function functionConfirm(event) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        __doPostBack('<%=GvExamRemarkRule.UniqueID%>', 'Deletes$' + paramID);
                        //alert(paramID);
                    } else {
