            ...
            {
                {
                    ...
                    arParms[0] = new SqlParameter("@TransportID", SqlDbType.Int);
                    arParms[0].Value = objfees.TransportID;
            ...
            {
                {
                    ...
                    arParms[2] = new SqlParameter("@TransportStudentTypeID", SqlDbType.Int);
                    arParms[2].Value = objfees.TransportStudentTypeID;
